...
export const VideoUploader: React.FC<VideoUploaderProps> = ({ onFileUpload, onYoutubeUrl, uploadState }) => {
  ...
  const progressPercent = uploadState ? Math.round(uploadState.progress * 100) : 0;
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {(uploadState?.status === 'uploading' || uploadState?.status === 'processing') && (
                <motion.div
                  className="w-full max-w-md h-2 bg-gray-200 rounded-full mt-4 overflow-hidden relative"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                >
                  <motion.div
        ...
        <div className="mt-4">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-12 pr-12 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm"
              disabled={uploadState?.status === 'uploading' || uploadState?.status === 'processing'}
            />
          ...
          <motion.button
            ...
            className={`
              mt-3 w-full py-3 rounded-xl font-medium text-white
